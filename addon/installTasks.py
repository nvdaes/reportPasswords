...
def onInstall():
	if gui.messageBox(
		_(
			...
			" Report passwords option of this add-on and configure NVDA to speak typed characters. This may be"
			" useful just in certain situations, so you can create an NVDA's configuration profile for this."
			" Do you want to set these options in a profile named reportPasswords with these settings now?"
		),
